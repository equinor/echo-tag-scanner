...
function defineModuledLess(env) {
  return {
    ...
    use: [
      env === 'dev' ? { loader: 'style-loader' } : { loader: MiniCssExtractPlugin.loader },
      {
...
export function defineModules(env) {
  ...
  switch (env) {
    case 'prod':
      return {
        rules: [transpiler, globalCSS, images]
      };
    default:
      return {
        rules: [markup, transpiler, globalCSS, images]
      };
  }
}

export { defineTranspiler, defineGlobalCSS, defineMarkup };
